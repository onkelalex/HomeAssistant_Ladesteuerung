...
select.msa_280024230201_mqtt_select

Batterieleistung

number.msa_280024230201

Gemeinsamer SOC

sensor.msa_280024230201_state_of_charge_system

Wallboxstatus

sensor.easee_charge_up_status

Aktueller Tibber-Preis

sensor.zumbuschstr_1_strompreis

Tibber-Diagrammdaten

sensor.zumbuschstr_1_diagramm_datenexport
...
Keine Preissteuerung; Normalmodus, sofern keine Sperre greift

Aus

An

Ebenfalls keine Preissteuerung; der Modusschalter allein startet nichts

An

Aus

Dynamische Auswahl der günstigsten Zeitfenster

An

An

Laden unterhalb des festen Ladewertes
...
Der Blueprint untersucht die verfügbaren Preise innerhalb des Planungshorizonts.

Er sucht die nächste Preisphase, die mindestens um den eingestellten Preisaufschlag über einem vorherigen günstigen Preis liegt.

Existiert eine solche Kostenspitze, wählt er die benötigten günstigsten Viertelstunden vor dieser Spitze.

Reicht die verbleibende Zeit nicht für eine vollständige Ladung, werden alle noch vorhandenen Blöcke vor der Spitze genutzt.

Gibt es keine ausreichend hohe Kostenspitze, wählt er trotzdem die benötigten günstigsten Viertelstunden des Planungshorizonts.

Sobald der Ziel-SOC erreicht ist, endet die Ladung.
...
Sofortladen: bis zum Ziel-SOC mit der eingestellten Ladeleistung.

Automatisches Preisladen: dynamisch oder nach festem Ladewert.

Wallbox lädt: Hausakku neutral halten.

Entladung gesperrt oder Preis nicht teuer genug: Hausakku neutral halten.

Keine Sperre beziehungsweise Preis teuer genug: Normalmodus general.
